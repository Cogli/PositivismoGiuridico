...
può apparire vera anche l'implicazione inversa, che se una norma è valida ad un istante e ordinamento allora esiste
una norma valida a quell'istante e ordinamento che la delega:

$$
∀x∀y∀z∃v(VALxyz \to (VALvvz \land DELvxz))
$$

Ma, aggiunge Kelsen, ciò è vero fino a un certo punto, poiché altrimenti si verificherebbe un regressus ad infinitum.
