...
Ciò che caratterizza il positivismo giuridico e lo distingue da altre concezioni del Diritto è una certa teoria della validità. Consideriamo
i seguenti passi di Kelsen:
...
rappresentano proprietà delle azioni. Similmente, la validità è una relazione tra norme, istanti e ordinamenti, non una proprietà delle norme.
...
```math
\begin{equation} Ciò che può essere valido è una norma ad un istante in un ordinamento.\tag{1}\end{equation}
```
