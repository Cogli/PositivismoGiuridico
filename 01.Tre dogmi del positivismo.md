...
ma da una norma delegante "ultima e suprema", la *norma fondamentale* o *grundnorm* di quell'ordinamento.

$$
∀x∀y∀z(VALxyz \to ∃v(DELvxy \land (VALvyz \lor GRNvy)))
$$

Congiungemdo le due implicazioni, arriviamo a quella che è la terza tesi del positivismo:
...
della ricorsione. Formulando esplicitamente la ricorsione, dati un istante *t* e un ordinamento *o*,
abbiamo che:
