...
2. Espressioni come "un/il significato dell'enunciato $e$ è $s$" sono sempre ellittiche e sottointendono il riferimento a un qualche linguaggio.

Un enunciato, insomma, non appartiene al dominio di un solo linguaggio, ma di un enorme numero di linguaggi, la maggior parte dei quali,
verosimilmente, non verrà mai utilizzata. 

Un linguaggio, ora, sarà quello che associa l'enunciato impiegato in una data produzione con le norme da essa poste.
